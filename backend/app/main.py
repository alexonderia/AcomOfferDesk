...
_DIRECT_PUBLIC_DETAIL_TRANSLATIONS = {
    ...
    "Insufficient permissions to update request amounts": "Недостаточно прав для изменения сумм заявки: требуется право на редактирование цен в допустимом контуре.",
