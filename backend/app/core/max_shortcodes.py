...
class MaxShortcodeCodec:
    @staticmethod
    def encode(payload: MaxShortcodePayload, *, secret: str) -> str:
        payload_dict = {
    ...
    @staticmethod
    def decode(code: str, *, secret: str) -> MaxShortcodePayload:
        raw = _b64decode(code)
    ...
    @staticmethod
    def ensure_valid(payload: MaxShortcodePayload, *, now: int | None = None) -> None:
