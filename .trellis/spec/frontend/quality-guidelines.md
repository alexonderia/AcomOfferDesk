...
- Prefer a layered light canvas with soft radial/linear depth instead of a flat fill so the chart reads as a dedicated workspace without turning into a dark or high-contrast board.
...
- Create visual depth through restrained elevation: department containers may feel heavier than employee cards, while module frames remain the lightest layer behind them.
